      ...
      <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
        ...
        <form action="#" method="POST" className="mt-8">
          <div className="space-y-5">
            <div>
              <label for="" className=" mb-1 text-base  float-left font-medium text-gray-900">
                {" "}
                Email address{" "}
              </label>
              <div className="mt-2">
            ...
            <div>
              <button
                type="button"
                className="inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-gray hover:bg-pink/80"
              >
                Get started{" "}
                <svg
