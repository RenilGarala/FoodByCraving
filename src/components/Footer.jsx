    ...
    <section className="relative overflow-hidden py-8 mt-20 rounded" style={{backgroundColor:color }}>
      <div className="container relative z-10 mx-auto px-2">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center pl-4 space-x-2">
                <span>
                  <div className="w-18 h-12 overflow-hidden rounded">
                    <img
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap mr-5">
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-black hover:border-gray-500">
                    <svg
                      width="14"
                      height="11"
                      viewBox="0 0 14 11"
